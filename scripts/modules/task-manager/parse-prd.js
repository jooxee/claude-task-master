...
ВНИМАНИЕ: Всегда отвечай только на русском языке. Все поля (title, description, details, testStrategy) заполняй на русском.`;
    ...
    "tasks": [
        {
            ...
            "description": "Создать новый репозиторий, инициализировать структуру проекта.",
            ...
        },
        ...
    ],
